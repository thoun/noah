...
function getAnimalTooltip(type, solo) {
    switch (type) {
...
function setupAnimalCard(game, cardDiv, uniqueId) {
    ...
    var power = getAnimalTooltip(type, game.isSoloMode());
    if (power) {
...
var FerrySpot = /** @class */ (function () {
    ...
    FerrySpot.prototype.removeFirstAnimalFromFerry = function () {
        ...
        if (this.animals.length) {
            var removedAnimalId = this.animals.shift().id;
...
var Noah = /** @class */ (function () {
    ...
    */
    ...
    Noah.prototype.isSoloMode = function () {
    ...
    Noah.prototype.showHelp = function () {
        ...
        ANIMALS_WITH_TRAITS.forEach(function (number) { return html += "<tr><td><div id=\"animal" + number + "\" class=\"animal\"></div></td><td>" + getAnimalTooltip(number, _this.isSoloMode()) + "</td></tr>"; });
        html += "</table>\n            </div>\n            <h1>" + _("Bonus animal traits") + "</h1>\n            <div class=\"help-section help-animals\">\n                <table>";
        BONUS_ANIMALS_WITH_TRAITS.forEach(function (number) { return html += "<tr><td><div id=\"animal" + number + "\" class=\"animal\"></div></td><td>" + getAnimalTooltip(number, _this.isSoloMode()) + "</td></tr>"; });
        html += "</table>\n            </div>\n        </div>";
        // Show the dialog
