...
This project is an adaptation for BoardGameArena of game Noah edited by Bombyx.
...
```
If you use it for another game, replace `noah` mentions on package.json `build:scss` script and on tsconfig.json `files` property.
